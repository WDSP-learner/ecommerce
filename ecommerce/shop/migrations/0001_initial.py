    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('general_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_categories', to='shop.generalcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
